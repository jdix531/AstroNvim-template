return {
  ...
  config = function()
    ...
    dap.adapters.coreclr = {
      type = "executable",
      command = "/Users/joshdix/.local/share/nvs/AstroNvim/lazy/netcoredbg-macOS-arm64.nvim/netcoredbg/netcoredbg",
    ...
    local dotnet_build_project = function()
      ...
      local cmd = "dotnet build -c Debug -o build/ " .. path .. " > /dev/null"
    ...
    local dotnet_get_dll_path = function()
      local request = function() return vim.fn.input("Path to dll to debug: ", vim.fn.getcwd() .. "/bin/Debug/", "file") end
    ...
    dap.configurations.cs = {
      {
        ...
        -- program = "/Users/joshdix/code/asi/asi-web-app/src/server/AsiWeb/bin/Debug/net9.0/AsiWeb.dll",
        program = function()
